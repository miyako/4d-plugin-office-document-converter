...
enum WordE315 {
	WordE315 = '\002\312\377\377',
	WordE315 = '\002\313\000\000',
	WordE3150x02cb0001 = '\002\313\000\001',
	WordE3150x02cb0002 = '\002\313\000\002',
	WordE3150x02cb0003 = '\002\313\000\003',
	WordE3150x02cb0004 = '\002\313\000\004',
	WordE3150x02cb0005 = '\002\313\000\005',
	WordE3150x02cb0006 = '\002\313\000\006',
	WordE3150x02cb0007 = '\002\313\000\007',
	WordE3150x02cb0008 = '\002\313\000\010',
	WordE3150x02cb0009 = '\002\313\000\011',
	WordE3150x02cb000a = '\002\313\000\012',
	WordE3150x02cb000b = '\002\313\000\013',
	WordE3150x02cb000c = '\002\313\000\014',
	WordE3150x02cb000d = '\002\313\000\015',
	WordE3150x02cb000e = '\002\313\000\016',
	WordE3150x02cb000f = '\002\313\000\017'
};
...
@interface WordPrintSettings : SBObject <WordGenericMethods>
...
- (void) reset:(Word4000)x;  // Resets a built-in command bar or command bar control to its default configuration.
...
- (void) copyObject:(Word4020)x NS_RETURNS_NOT_RETAINED;  // Copies the content of the object to the clipboard.
...
- (WordBorder *) getBorder:(Word4019)x whichBorder:(WordE122)whichBorder;  // Returns the specified border object.
...
- (WordBorder *) getBorder:(Word4052)x whichBorder:(WordE122)whichBorder;  // Returns the specified border object.
...
- (WordE125) case;  // Returns or sets a constant that represents the case of the text in the text range.
- (void) setCase: (WordE125) case;
